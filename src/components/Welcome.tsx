...
const Welcome: React.FC = () => {
  return (
    <div className="mx-auto max-w-6xl px-4 sm:px-8 lg:px-12 py-6 text-white sm:ml-10 md:ml-20">
      <h1 className="max-w-5xl pt-40 md:pt-[20vh] 2xl:pt-[30vh] font-display text-3xl md:text-5xl font-medium tracking-tight text-white [text-wrap:balance] sm:text-6xl p-4 pl-0">
        João Vitor Cunha <span className="wave">👋</span>
      </h1>
      <div className="flex mb-2 text-sm md:text-lg">
        Open to Work{" "}
      ...
      <p className="max-w-3xl mb-4 text-sm md:text-lg">
